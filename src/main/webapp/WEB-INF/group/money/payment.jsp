...
<head>
	...
	function viewList {
		int i = 0;
		while (paymentList[i] != null){
			document.write( "<table><tr><td class='individualBack'>");
			document.write(paymentList[i].getPaymentDescription);
			document.write("&nbsp;&nbsp;&nbsp;&nbsp");
			document.write(paymentList[i].getPrice);
			document.write("&nbsp;&nbsp;&nbsp;&nbsp");
			document.write(paymentList[i].getPaymentDate);
			document.write("&nbsp;&nbsp;&nbsp;&nbsp");
